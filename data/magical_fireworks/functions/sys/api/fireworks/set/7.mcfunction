#> magical_fireworks:sys/api/fireworks/set/7
#
# 7列目に花火データをセットする
#
# @api
...
# 7列目のデータを仮ストレージに格納する
    data modify storage magical_fireworks:temp CacheFireworksData.Middle set from entity @s SelectedItem.tag.MagicalFireworks.Data.tag.BlockEntityTag.Items[{Slot:6b}]
    data modify storage magical_fireworks:temp CacheFireworksData.Left set from entity @s SelectedItem.tag.MagicalFireworks.Data.tag.BlockEntityTag.Items[{Slot:15b}]
    data modify storage magical_fireworks:temp CacheFireworksData.Right set from entity @s SelectedItem.tag.MagicalFireworks.Data.tag.BlockEntityTag.Items[{Slot:24b}]
...
# 7列目のデータが花火であればそれをMagicalFireworksに書き換える
