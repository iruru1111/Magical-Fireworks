#> magical_fireworks:sys/api/fireworks/set/5
#
# 5列目に花火データをセットする
#
# @api
...
# 5列目のデータを仮ストレージに格納する
    data modify storage magical_fireworks:temp CacheFireworksData.Middle set from entity @s SelectedItem.tag.MagicalFireworks.Data.tag.BlockEntityTag.Items[{Slot:4b}]
    data modify storage magical_fireworks:temp CacheFireworksData.Left set from entity @s SelectedItem.tag.MagicalFireworks.Data.tag.BlockEntityTag.Items[{Slot:13b}]
    data modify storage magical_fireworks:temp CacheFireworksData.Right set from entity @s SelectedItem.tag.MagicalFireworks.Data.tag.BlockEntityTag.Items[{Slot:22b}]
...
# 5列目のデータが花火であればそれをMagicalFireworksに書き換える
